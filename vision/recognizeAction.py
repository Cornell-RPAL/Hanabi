                ...
                if len(new_state['hand']) == 5:
                    ...
                    if len(old_hand - new_hand) == 1:
                        ...
                        if action_card in new_state['board']:
                            ...
                            return PlaySuccess(PLAYER, action_card, [card_ix = new_state['board'].index(action_card)])
                        if action_card in new_state['discard']: #could also just check top card
                            ...
                            return Discard(PLAYER, action_card, [card_ix = new_state['discard'].index(action_card)])
                        else:
                            pass
