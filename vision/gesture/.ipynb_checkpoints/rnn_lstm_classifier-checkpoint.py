...
def main():
  ...
  #  class_names = ["fist","pinch","wave","victory","stop","thumbsup"]
    ...
    X_test_path = "gesture_data/xtest.npy"
    Y_test_path = "gesture_data/ytest.npy"
    ...
    y_vector_dim = y_train.shape[1] # number of features or columns
    ...
    print(X_train.shape)
    input_shape = X_train.shape # store input_shape
