...
print(current_loc)
read_path = current_loc + "/vision/data/webcam/before/dis1.jpg"
print(read_path)
#/Users/noahthompson/CS/hanabi_project/Hanabi/vision/data/webcam/before/dis2.jpg
save_path = current_loc + "/vision/data/webcam/after/dis1.jpg"
